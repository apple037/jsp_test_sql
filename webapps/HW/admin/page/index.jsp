...
<%
  ...
  if (p_name != null && p_id != null && p_location != null && p_photo != null && p_description != null){
    database.connectDB();
    database.updateData(p_id , p_name , p_location , p_photo , p_description);
  }
                                     ...
                                     %>
                                        <tr>
                                          <form id = "form<%=id%>" action="index.jsp" method="POST">
                                            ...
                                            <td id = "photo<%=id%>"><img id = "photoURL1" src="<%=photo%>" width=50></td>
                                            <td><%=createdAt%></td>
                                            <td>
      ...
      $("button").on("click",function(){
        ...
        switch(click_text){
          case "修改":
            ...
            $("#description" +id).html('<input type="text" name="description" id = "input_description' + id + '"value="' +  $("#description" +id).text() + '" />');
